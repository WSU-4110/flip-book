...
$reg = "INSERT into posts (bookid, email, bookTitle, author, ISBN, edition, subject, classNum, price, img) VALUES (NULL,'$email', '$bookTitle', '$author', '$ISBN', '$edition', '$subject', '$classNum', '$price', '$img')";
